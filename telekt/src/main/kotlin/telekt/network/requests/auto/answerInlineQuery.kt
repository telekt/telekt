...
import rocks.waffle.telekt.types.InlineQueryResult
 ...
 */
@Serializable data class AnswerInlineQuery(
    ...
    @Transient override val method = TelegramMethod.answerInlineQuery
    @Transient override val resultDeserializer: KSerializer<out Unit> = Unit.serializer()
    override fun stringify(json: Json): String = json.stringify(AnswerInlineQuery.serializer(), this)
}